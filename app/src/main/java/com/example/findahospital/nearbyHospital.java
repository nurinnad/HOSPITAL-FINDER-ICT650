...
public class nearbyHospital extends FragmentActivity implements OnMapReadyCallback,
    ...
    DatabaseReference db = FirebaseDatabase.getInstance("https://lab5nad-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference("Users");
    ...
    private String getUrl(double latitude , double longitude , String nearbyPlace)
    {
        ...
        googlePlaceUrl.append("location="+2.2027+","+102.2454);
        googlePlaceUrl.append("&radius="+PROXIMITY_RADIUS);
        googlePlaceUrl.append("&type="+nearbyPlace);
        googlePlaceUrl.append("&sensor=true");
        googlePlaceUrl.append("&key="+"AIzaSyBmjZfDZihIxpJvS_yC2bqR_gzpycyq5Hc");
